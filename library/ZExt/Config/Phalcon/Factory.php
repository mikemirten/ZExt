...
namespace ZExt\Config\Phalcon;

use ZExt\Config\Factory as FactoryOrigin;
use Phalcon\Config;

/**
 * Configuration holder based on the Phalcon\Config
 * 
 * @category   ZExt
 * @package    Config
 * @subpackage Config
 ...
 * @version    1.0
 */
class Factory extends FactoryOrigin {
